...
function __cmd_x_main$main(){
  ...
  const children_20=[[[5,[0,label_4],(c_6,e_7)=>$host_HostUi_write(c_6[2],count_5[0],(n_8=>n_8+1n)($host_HostUi_read(c_6[2],count_5[0])))]],__cmd_x_main$badge$u3rqgv([0,label_4],[1,count_5]),__cmd_x_main$badge$u3rqgv($k0,[2,c_9=>$ui_effect_Scope_read(c_9,count_5[0])*2n])];
