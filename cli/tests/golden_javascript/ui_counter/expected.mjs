const $k0=[0,'doubled'];
const $k1=[900n,'lay-col'];
const $k2=[$k1];
const $k3=[$k2];
const $k4=[5,$k3];
const $k5=[3150n,'px-r0_5'];
const $k6=[5550n,'r-6'];
const $k7=[4650n,'bg-f0f0f5'];
const $k8=[4800n,'fg-18181b'];
const $k9=[4655n,'hover_bg-18181b'];
const $k10=[4805n,'hover_fg-f0f0f5'];
