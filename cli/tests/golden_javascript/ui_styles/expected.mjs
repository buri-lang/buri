...
const $k2=[4002n,'md_p-r2'];
const $k3=[3402n,'md_gap-16'];
const $k4=[5403n,'lg_maxw-r64'];
const $k5=[7406n,'sm_hover_r-4'];
const $k6=[$k0,$k1,$k2,$k3,$k4,$k5];
const $k7=[$k6];
const $k8=[5,$k7];
const $k9=[$k8];
const $k10=[4200n,'px-r0_5'];
const $k11=[7400n,'r-6'];
const $k12=[6200n,'bg-f0f0f5'];
const $k13=[6400n,'fg-18181b'];
const $k14=[6205n,'hover_bg-18181b'];
const $k15=[6405n,'hover_fg-f0f0f5'];
const $k16=[$k10,$k11,$k12,$k13,$k14,$k15];
const $k17=[$k16];
const $k18=[5,$k17];
const $k19=[$k18];
const $k20=[2400n,'grow-1'];
const $k21=[$k10,$k20];
const $k22=[$k21];
const $k23=[5,$k22];
const $k24=[$k23];
...
const $k29=[3,$k28,[]];
const $k30=[$k29];
const $k31=[1200n,'lay-col'];
const $k32=[$k31];
const $k33=[$k32];
const $k34=[5,$k33];
const $k35=[1200n,'lay-row'];
const $k36=[$k35];
const $k37=[$k36];
const $k38=[5,$k37];
