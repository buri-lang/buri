...
function __cmd_x_main_buri$main(){
  ...
  const a_8=__cmd_x_main_buri$noisy$u3rqgv(ctx_0,'one',1n);
  const a_6=__cmd_x_main_buri$noisy$u3rqgv(ctx_0,'two',2n);
  let $t3;
  if(p_1===0){
    $t3=0n;
  }else if(p_1===1){
    $t3=__cmd_x_main_buri$noisy$u3rqgv(ctx_0,'three',3n);
  }else{
    $abort('no arm matched');
  }
  const b_7=$t3;
