...
function __cmd_x_main$main(){
  const ctx_0=[[],[],[],[]];
  const count_1=[$host_HostUi_signal(ctx_0[2],0)];
  const id_12=$host_HostUi_memo(ctx_0[2],s_2=>$ui_effect_Scope_read(s_2,count_1[0])*2);
  ...
  $host_HostUi_write(ctx_0[2],count_1[0],(n_5=>n_5+1)($host_HostUi_read(ctx_0[2],count_1[0])));
  const text_32='count '+String($host_HostWatch_read(ctx_0[3],count_1[0]));
  $host_HostStdout_println(ctx_0[1],text_32);
  $host_HostUi_write(ctx_0[2],count_1[0],20);
