const $k0=[5425n,'bg-t_app_bg'];
const $k1=[5600n,'fg-t_app_fg'];
const $k2=[$k0,$k1];
const $k3=[$k2];
const $k4=[5,$k3];
const $k5=[$k4];
const $k6=[3675n,'px-r0_5'];
const $k7=[6475n,'r-6'];
const $k8=[5425n,'bg-t_cardlib_surface'];
const $k9=[5600n,'fg-t_cardlib_onSurface'];
const $k10=[5430n,'hover_bg-t_cardlib_danger'];
const $k11=[$k6,$k7,$k8,$k9,$k10];
const $k12=[$k11];
const $k13=[5,$k12];
const $k14=[$k13];
const $k15=[1050n,'lay-row'];
const $k16=[$k15];
const $k17=[$k16];
const $k18=[5,$k17];
...
function __cmd_x_main_buri$main(){
  ...
  const count_28=[1,count_11];
  const content_36=[2,c_29=>{
    let $t3;
    if(count_28[0]===0){
      $t3=count_28[1];
    }else if(count_28[0]===1){
      $t3=ui_signal$Signal_get$xiaice(count_28[1],c_29);
    }else if(count_28[0]===2){
      $t3=count_28[1](c_29);
    }else{
      $abort('no arm matched');
    }
  ...
  const $t8=ui_node$column$u3rqgv($k5,[[[5,[0,label_10],[],(c_12,e_13)=>$host_HostUi_write(c_12[2],count_11[0],(n_14=>n_14+1n)($host_HostUi_read(c_12[2],count_11[0])))]],[[3,[$k18,[0,$k14]],[[[1,[0,label_10]]],[[1,content_36]]]]]]);
