...
const $k4=[5,$k3];
const $k5=[$k4];
const $k6=[3150n,'px-r0_5'];
const $k7=[5550n,'r-6'];
const $k8=[4650n,'bg-t_cardlib_surface'];
const $k9=[4800n,'fg-t_cardlib_onSurface'];
const $k10=[4655n,'hover_bg-t_cardlib_danger'];
const $k11=[$k6,$k7,$k8,$k9,$k10];
const $k12=[$k11];
const $k13=[5,$k12];
const $k14=[$k13];
const $k15=[900n,'lay-row'];
const $k16=[$k15];
const $k17=[$k16];
const $k18=[5,$k17];
