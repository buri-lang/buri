const $k0=[6200n,'bg-t_app_bg'];
const $k1=[6400n,'fg-t_app_fg'];
const $k2=[$k0,$k1];
const $k3=[$k2];
const $k4=[5,$k3];
const $k5=[$k4];
...
const $k7=[7400n,'r-6'];
const $k8=[6200n,'bg-t_cardlib_surface'];
const $k9=[6400n,'fg-t_cardlib_onSurface'];
const $k10=[6205n,'hover_bg-t_cardlib_danger'];
const $k11=[$k6,$k7,$k8,$k9,$k10];
const $k12=[$k11];
const $k13=[5,$k12];
const $k14=[$k13];
const $k15=[1200n,'lay-row'];
const $k16=[$k15];
const $k17=[$k16];
const $k18=[5,$k17];
