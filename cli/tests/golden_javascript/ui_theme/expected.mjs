...
const $k5=[$k4];
const $k6=[0,false];
const $k7=[3675n,'px-r0_5'];
const $k8=[6475n,'r-6'];
const $k9=[5425n,'bg-t_cardlib_surface'];
const $k10=[5600n,'fg-t_cardlib_onSurface'];
const $k11=[5430n,'hover_bg-t_cardlib_danger'];
const $k12=[$k7,$k8,$k9,$k10,$k11];
const $k13=[$k12];
const $k14=[5,$k13];
const $k15=[$k14];
const $k16=[1050n,'lay-row'];
const $k17=[$k16];
const $k18=[$k17];
const $k19=[5,$k18];
