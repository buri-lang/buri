...
const $k3=[5,$k2];
const $k4=[$k3];
const $k5=[630,'px-r0_5'];
const $k6=[1080,'r-6'];
const $k7=[930,'bg-t_cardlib_surface'];
const $k8=[960,'fg-t_cardlib_onSurface'];
const $k9=[935,'hover_bg-t_cardlib_danger'];
const $k10=[$k5,$k6,$k7,$k8,$k9];
const $k11=[5,$k10];
const $k12=[$k11];
const $k13=[180,'lay-row'];
const $k14=[$k13];
const $k15=[5,$k14];
const $k16=[0,220,38,38];
const $k17=[0,24,24,27];
const $k18=[0,240,240,245];
const $k19=[0,255,255,255];
const $k20=[180,'lay-col'];
const $k21=[$k20];
const $k22=[5,$k21];
...
function __cmd_x_main$main(){
  ...
  const $t6=ui_node$column$u3rqgv($k4,[[5,[0,label_7],(c_9,e_10)=>$host_HostUi_write(c_9[2],count_8[0],(n_11=>n_11+1)($host_HostUi_read(c_9[2],count_8[0])))],[3,[$k15,[0,$k12]],[[1,[0,label_7]],[1,content_32]]]]);
...
function ui_node$column$u3rqgv(styles_0,children_1){
  return [3,[$k22,[0,styles_0]],children_1];
}
