...
function __cmd_x_main_buri$main(){
  ...
  $host_HostStdout_println(ctx_0[1],String($str_len(trimmed_2))+' '+String($list_len(words_3))+' '+$str($str_contains(joined_7,'QUICK')));
  $host_HostStdout_println(ctx_0[1],$str($str_startsWith(trimmed_2,'the'))+' '+$str($str_endsWith(trimmed_2,'fox')));
  return $k0;
}
