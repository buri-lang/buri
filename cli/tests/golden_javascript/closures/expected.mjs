...
function __cmd_x_main_buri$main(){
  ...
  $host_HostStdout_println(ctx_0[1],String(core_list_lib_buri$sum(biased_4))+' '+String(core_list_lib_buri$sum(doubled_6))+' '+String(summed_9)+' '+String($list_len(big_11)));
  return $k1;
}
function core_list_lib_buri$sum(self_0){
