...
function __cmd_x_main$main(){
  const ctx_0=[[],[]];
  const fs_1=__cmd_x_main$adders$u3rqgv(ctx_0,0n,[]);
  const gs_2=__cmd_x_main$scalers$u3rqgv(ctx_0,7n,0n,[]);
  $host_HostStdout_println(ctx_0[1],String($list_len($list_map(fs_1,ctx_0,f_3=>f_3(100n))))+' '+String(__cmd_x_main$sumTo(100n,0n)));
