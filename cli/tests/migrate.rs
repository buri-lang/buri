...
///
/// E7 is the conformance repository's first two packages and E8 the next
/// three; E10 is every row below the first.
const CORPORA: &[Corpus] = &[
    Corpus {
        root: "cli/tests/conformance",
        packages: &["lib/data", "lib/collections", "lib/semantics", "lib/json", "lib/proto"],
        targets: &[
            "//lib/data",
            "//lib/collections",
            "//lib/semantics",
