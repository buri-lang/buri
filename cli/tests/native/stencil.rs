...
/// *and* an entry point to put in front of it" — false wherever `cc` could not
/// build the host's library, and false for a host whose machine `asm.rs` has no
/// shim for. Both of this repository's are covered today.
///
