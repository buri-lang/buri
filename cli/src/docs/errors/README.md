...
| Test | What it holds |
|---|---|
| `docs::documents::every_emitted_code_is_documented` | Every code any Rust source attaches has a page in one of the two catalogs, or a row in `cli/src/docs/build/cli.md`. |
