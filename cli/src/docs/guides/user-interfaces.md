...
([the standard library](../reference/standard-library.md)), ship with the toolchain, and
...
program is rejected ([`style-not-static`](../reference/errors/style-not-static.md)).
