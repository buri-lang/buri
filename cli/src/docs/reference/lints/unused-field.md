---
title: Every field is read
severity: warning
message: "nothing reads `{type}.{name}`"
...
---
Deleting the field is an edit at every literal, which is the point: those are
the sites that were computing a value for nobody.
