...
An enum on a surface is not reported: `lib.buri` for a library's, `testing/lib.buri` for a fixture's. A consumer this analysis cannot see may build any of its cases.
