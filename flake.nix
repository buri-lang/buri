    ...
    flake-utils.lib.eachDefaultSystem (
      ...
      let
        ...
        nightly = {
          ...
          hashes = {
            "aarch64-apple-darwin" = "d011553c4a180feca3d56e06134f33bca9782e8098a0a3bc36aa992ee1b4fb61"; # nightly:hash:aarch64-apple-darwin
            "x86_64-unknown-linux-musl" = "241894b3f318c1ecc8a7868b10af5fd3faa5aabc9bae29b2b99fb8b2e1ac30fe"; # nightly:hash:x86_64-unknown-linux-musl
            "aarch64-unknown-linux-musl" = "d37e1098fc7ed9abba1734ad0c4a839cf15d3ea5bd5f6b8010a5fcafaa010094"; # nightly:hash:aarch64-unknown-linux-musl
          };
        };
