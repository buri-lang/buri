...
| [`non-goals.md`](./non-goals.md) | What the language deliberately does not have, what is deferred and why they are deferred together, and the open trade-offs flagged as open. It was section 14 of the specification, and it now also holds the struct-of-arrays argument the standard library kept sending people to. |
